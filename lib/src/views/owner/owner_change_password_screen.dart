...
import '../../viewmodels/owner_change_password_viewmodel.dart';
...
class OwnerChangePasswordScreen extends StatefulWidget {
  const OwnerChangePasswordScreen({
    super.key,
    this.viewModel,
    this.profileImageUrl,
  });

  final OwnerChangePasswordViewModel? viewModel;
...
class _OwnerChangePasswordScreenState extends State<OwnerChangePasswordScreen> {
  late final OwnerChangePasswordViewModel _viewModel;
  ...
  void initState() {
    ...
    _viewModel = widget.viewModel ?? OwnerChangePasswordViewModel();
