...
class HomeRepository {
  ...
  List<StatMetric> getSystemStats() => const [
    StatMetric(icon: Icons.emoji_events, value: '156', label: 'GIẢI ĐẤU'),
    StatMetric(icon: Icons.pets, value: '328', label: 'NGỰA ĐUA'),
    StatMetric(icon: Icons.sports, value: '145', label: 'NÀI NGỰA'),
    StatMetric(icon: Icons.groups, value: '2,845', label: 'KHÁN GIẢ'),
  ];
