...
class AboutRepository {
  ...
  List<AboutBenefit> getBenefits() => const [
        ...
        AboutBenefit(
          ...
          title: 'Hiệu quả',
          description:
              'Tối ưu hóa quy trình quản lý và vận hành nhanh chóng.',
        ),
        AboutBenefit(
          icon: Icons.verified_user_outlined,
          title: 'Bảo mật',
          description:
              'Đảm bảo an toàn thông tin và dữ liệu người dùng tuyệt đối.',
        ),
      ];
  ...
  List<AboutProcessStep> getProcessSteps() => const [
        ...
        AboutProcessStep(
          ...
          description:
              'Đăng ký ngựa hoặc jockey tham gia các giải đấu phù hợp.',
        ),
        AboutProcessStep(
          step: 3,
