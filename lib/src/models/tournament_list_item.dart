...
class TournamentListItem {
  ...
  factory TournamentListItem.fromJson(Map<String, dynamic> json) {
    ...
    return TournamentListItem(
      id: id,
      title: name.isNotEmpty ? name : 'Giải đấu${id.isEmpty ? '' : ' #$id'}',
  ...
  bool get isOwnerCompleted => status == 'COMPLETED' || status == 'CANCELLED';

  bool get canOwnerJoin => status == 'OPEN_REGISTRATION';

  String get ownerCapacityLabel =>
      maxTeams == null ? 'Chưa cập nhật số đội' : 'Tối đa $maxTeams đội';
